...
public class ShadowProject {
	...
	private Optional<ActionableMarkerResolution> createActionableResolutions(
		...
		Optional<ActionableMarkerResolution> optionalResolution = Optional.absent();
		...
		if (optionalContext.isPresent()) {
			...
			optionalResolution = Optional.of(new ActionableMarkerResolution(this,
					resolution, markers, fixerDescriptor, baseMarkers));
		}
		return optionalResolution;
	}
